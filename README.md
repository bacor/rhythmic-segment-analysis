...
- **`notebooks/`** Jupyeter notebooks that generate the figures etc.
- **`tex/`** LaTeX sources for the supplementary materials and figures. `tex/.latexmkrc` controls build output. Note this directory also contains a small package `tex/rsa` for drawing segment projections (figure 2 and 3 in the paper).
