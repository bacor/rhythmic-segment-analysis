...
Finally, the novel concept of quantal data proves to be fruitful and 
% Referring to intervals that cluster around integer multiples of a smallest duration, it 
may shed light on wider debates regarding small-integer-ratio rhythms. 
...
Segments will be decomposed into a \emph{duration} and a \emph{pattern}, the latter being the ratios between the intervals in a segment (e.g. $1 : 1 : 2$). 
