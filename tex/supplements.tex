...
\begin{figure}[h]
  \centering
  \includegraphics[width=.5\textwidth]{../figures/synthetic-intervals-distributions.pdf}
  \caption{%
...
\begin{figure}[h!]
  \includegraphics[width=\textwidth]{../figures/plot-types/event-plots.pdf}
  \caption{%
...
\begin{figure}[h!]
  \includegraphics[width=\textwidth]{../figures/plot-types/raster-plots.pdf}
  \caption{%
...
\begin{figure}[h!]
  \includegraphics[width=\textwidth]{../figures/plot-types/phase-plots-scatter.pdf}
  \caption{
...
\begin{figure}[h!]
  \includegraphics[width=\textwidth]{../figures/plot-types/phase-plots-trajectory.pdf}
  \caption{
...
\begin{figure}[h!]
  \includegraphics[width=\textwidth]{../figures/plot-types/pattern-duration.pdf}
  \caption{%
...
\begin{figure}[h!]
  \includegraphics[width=\textwidth]{../figures/plot-types/ratio-plots.pdf}
  \caption{%
...
\begin{figure}[h]
  \includegraphics[width=\textwidth]{../figures/cluster-analysis-3d.pdf}
  \caption{%
    Cluster analysis of the repeated synthetic rhythm using segments of length 3.
    Note that the axes of the simplex have been rotated with respect to figure 3 in the paper.
    \label{fig:cluster-analysis-3d}
  }
\end{figure}
