...
% To summarize, we have two spaces:
% \[
% \begin{alignedat}{3}
%     &\text{Segment space:}\quad
%         &(\RR_{\ge 0}, \;d), \quad
%         &d(\vx, \vy) = \|\vx -\vy\|_1 \\
%     &\text{Pattern space:}\quad
%         &(\Delta^{n-1}, \; \delta), \quad
%         &\delta(\vr, \vs) = \tfrac{1}{2}\|\vr -\vs\|_1\\
%     &\text{Duration space}:
%         &(\RR_{\ge 0}, d)
%         & \\
%     &\text{Pattern-duration space:}\quad
%         &((\Delta^{n-1}\times\RR, )
%         &
% \end{alignedat}
% \]
...
\begin{figure}[h!]
  ...
  \caption{
    Event plots of synthetic rhythmic data. Event mark each event with a vertical line.
  }
\end{figure}
...
\begin{figure}[h!]
  ...
  \caption{Pattern-duration plots for synthetic rhythmic data.}
\end{figure}


\begin{figure}[h!]
  \includegraphics[width=\textwidth]{../figures/plot-types/ratio-plots.pdf}
  \caption{Ratio plots for synthetic rhythmic data.}
\end{figure}
...
\begin{figure}[h]
  ...
  \caption{%
    A cluster transition network using length-3 segments shown in the rhythm triangle.
