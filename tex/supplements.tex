...
The Python package rhythmic-segments can be installed using pip, and documentation is available on bacor.github.io/rhythmic-segments. Data and code used for the examples in this paper is available online: \textbf{[WILL BE ADDED AFTER FIRST RELEASE]}. Note in particular that it contains a small LaTeX package used to produce figures 2 and 3.
